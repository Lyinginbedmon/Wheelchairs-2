...
public class WHCScreenHandlerTypes
{
	...
	public static final RegistrySupplier<ScreenHandlerType<ChairInventoryScreenHandler>> WHEELCHAIR_INVENTORY_HANDLER	= register("wheelchair_inventory", new ScreenHandlerType<>((syncId, playerInventory) -> new ChairInventoryScreenHandler(syncId, playerInventory, (EntityWheelchair)playerInventory.player.getVehicle()), FeatureFlags.VANILLA_FEATURES));
