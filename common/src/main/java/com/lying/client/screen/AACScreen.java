...
public class AACScreen extends Screen
{
	...
	public static final Identifier TEXTURE = Reference.ModInfo.prefix("textures/gui/speech_tablet.png");
	...
	{
		if(message != null)
			AACMessagePacket.sendToServer(message, mc.player);
		close();
	}
	...
	public void renderBackground(DrawContext context, int mouseX, int mouseY, float delta)
	{
		...
		context.drawTexture(RenderLayer::getGuiTextured, TEXTURE, i, 10, 0, 0, 0, 430, 235, 512, 512);
	}
	...
	private class ModeButtonWidget extends ButtonWidget
	{
		...
		{
			context.drawTexture(RenderLayer::getGuiTextured, TEXTURE, getX(), getY(), 0, 0, 235 + (isHovered() ? 20 : 0), 20, 20, 512, 512);
			context.drawTexture(RenderLayer::getGuiTextured, TEXTURE, getX(), getY(), 0, 20, 235 + (parentScreen.messageMode.ordinal() * 20), 20, 20, 512, 512);
		}
