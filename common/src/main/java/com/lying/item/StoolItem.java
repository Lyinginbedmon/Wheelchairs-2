...
public class StoolItem extends EntityPlacerItem<StoolEntity> implements IBonusBlockItem
{
	...
	public StoolItem(Settings settings)
	{
	...
	protected StoolEntity makeEntity(ServerWorld serverWorld, ItemStack stack, @Nullable PlayerEntity player, BlockPos pos)
	{
		StoolEntity stool = WHCEntityTypes.STOOL.get().spawnFromItemStack(serverWorld, stack, player, pos, SpawnReason.SPAWN_ITEM_USE, true, true);
		if(stool != null)
