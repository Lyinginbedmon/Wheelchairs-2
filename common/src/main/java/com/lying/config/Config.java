...
public abstract class Config
{
	...
	public void read()
	{
		...
		{
			Wheelchairs.LOGGER.error("Generated new config file "+fileName);
			save();
			return;
		}
		catch(IOException e)
		{
			Wheelchairs.LOGGER.error("Couldn't read config file "+fileName);
			e.printStackTrace();
		}
	...
	public void save()
	{
		try
		{
			...
			writer.close();
			if(!fileExists)
				Wheelchairs.LOGGER.info("Generated new config file "+fileName);
		}
		catch(IOException e)
		{
			Wheelchairs.LOGGER.error("Couldn't read config file "+fileName);
