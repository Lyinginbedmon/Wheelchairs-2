...
public class EntityWheelchair extends WheelchairsRideable implements JumpingMount, ItemSteerable, IFlyingMount, IParentedEntity
{
	...
	public boolean hasParent() { return hasUpgrade(WHCUpgrades.HANDLES) && getDataTracker().get(USER_ID).isPresent(); }
	...
	{
		if(!hasUpgrade(WHCUpgrades.HANDLES) || hasPassenger(parent))
			return;
